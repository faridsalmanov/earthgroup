    ...
    <>
      <section className="bg-brand-900 py-20 px-4">
        <div className="max-w-5xl mx-auto">
          <h1 className="font-display text-4xl sm:text-5xl text-white font-bold mb-4">{t('contact.title')}</h1>
          <p className="text-brand-200 text-lg max-w-xl">{t('contact.subtitle')}</p>
        </div>
      </section>
